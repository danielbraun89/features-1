...
EXPRESS_APPLICATION_GENERATOR=${VERSION:-"latest"}
...
if [ "$EXPRESS_APPLICATION_GENERATOR" != "none" ]; then
    if [ "$EXPRESS_APPLICATION_GENERATOR" =  "latest" ]; then
        util_command="express-generator"
    else
        util_command="express-generator@$EXPRESS_APPLICATION_GENERATOR"
    fi
